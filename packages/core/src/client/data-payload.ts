...
export function parseDataPayload(data: Record<string, unknown>): RouteDataPayload {
  return {
...
export interface RouteModuleView {
  ...
  loaderDeps?: (args: { searchParams: URLSearchParams }) => unknown[];
...
export function moduleView(mod: unknown): RouteModuleView | null {
  return (mod as RouteModuleView | null) ?? null;
}
