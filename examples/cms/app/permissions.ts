...
export const PERMISSION_GROUPS: { label: string; items: Permission[] }[] = [
  { label: "Content", items: ["posts.manage", "pages.manage", "categories.manage", "media.manage", "menus.manage", "fields.manage"] },
  { label: "Administration", items: ["users.manage", "roles.manage"] },
];

/** Default permissions for the seeded "Editor" role. */
export const EDITOR_PERMISSIONS: Permission[] = ["posts.manage", "pages.manage", "categories.manage", "media.manage", "fields.manage"];
