  ...
  return (
    <>
      <div className="admin-bar">
        ...
        <Link to="/admin/posts" style={{ color: "var(--accent)", textDecoration: "none" }}>← All posts</Link>
      </div>
      <PostForm categories={categories} media={media} customFields={customFields} state={state} submitLabel="Create post" />
    </>
  );
}
